...
describe('Relation side collections', () => {
    ...
    test('return configured entity ids for binary relations', () => {
...
describe('Relation configuration helpers', () => {
...
describe('Relation arity helpers', () => {
    ...
    test('detect ternary relations from explicit arity', () => {
        const relation = createTestTernaryRelation()
...
describe('Relation cardinality and attribute support', () => {
...
describe('Relation data creation', () => {

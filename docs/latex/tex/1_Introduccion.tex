...
Dentro de este alcance se consideran tanto los cambios realizados en el editor como la revisión de las reglas de validación, la transformación hacia el modelo relacional y la generación de SQL cuando corresponde. No se pretende construir una herramienta profesional completa de diseño de bases de datos ni cubrir todas las variantes posibles del modelo Entidad-Relación, sino avanzar sobre una base previa y dejar el proyecto en un estado más completo, coherente y documentado.

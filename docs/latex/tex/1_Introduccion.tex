...
% Figura: captura general del editor web con un diagrama Entidad-Relación cargado.
...
% Figura: esquema del alcance del trabajo, separando funcionalidades implementadas y funcionalidades fuera del alcance.

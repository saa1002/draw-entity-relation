...
El soporte de jerarquías ISA se planteó de forma limitada y controlada. La aplicación permite representar una generalización con una o varias especializaciones, y transforma esta estructura generando una tabla para la entidad general y una tabla para cada especialización, donde la clave heredada actúa como clave primaria y clave foránea. No se incorporaron variantes más avanzadas como totalidad o parcialidad, especializaciones solapadas o exclusivas, discriminantes o herencia múltiple real. Esta decisión permitió implementar una primera base funcional sin aumentar el alcance de forma excesiva.
...
Otro resultado relevante del proyecto es la mejora de la usabilidad del editor. Se reorganizó la interfaz, se revisaron los mensajes de validación y confirmación, se incorporaron ayudas dentro de la aplicación y se añadieron operaciones de apoyo como selección múltiple, ajuste de vista, exportación visual, importación JSON y generación de estructuras de ejemplo. Estas mejoras no cambian la notación Entidad-Relación, pero facilitan el uso de la herramienta y la revisión de los diagramas creados.
...
Al estar orientada a un contexto académico, la herramienta no busca sustituir la explicación teórica del modelo Entidad-Relación ni competir con soluciones profesionales de diseño de bases de datos. Su finalidad es servir como apoyo práctico para construir diagramas, validarlos y observar una posible traducción al modelo relacional y a SQL.

...
Otros elementos más avanzados, como las agregaciones o las variantes completas de ISA, se mantienen como posibles líneas de trabajo futuro. Esta delimitación permite ajustar el desarrollo al objetivo principal del trabajo: evolucionar el editor heredado manteniendo la coherencia entre el diagrama visual, el modelo interno y la generación de SQL.

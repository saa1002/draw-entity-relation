...
% Figura: ejemplo básico de diagrama Entidad-Relación con entidad, atributos, relación y cardinalidades.
...
% Figura: ejemplo de atributo compuesto y atributo multivaluado en notación Entidad-Relación.

\subsection{Interrelaciones ternarias}

Las interrelaciones ternarias son relaciones en las que participan tres entidades. No siempre pueden sustituirse por varias relaciones binarias sin perder significado, ya que en algunos casos el hecho que se quiere representar depende de la combinación de los tres participantes.
...
% Figura: ejemplo de interrelación ternaria con tres entidades participantes y cardinalidades.
...
En este tipo de jerarquías, las especializaciones heredan la identificación de la entidad general. Además, pueden existir variantes avanzadas, como jerarquías totales o parciales, solapadas o exclusivas, o con discriminantes. Sin embargo, no siempre es necesario implementar todas estas posibilidades para que el modelo sea útil.
...
% Figura: ejemplo de jerarquía ISA con una entidad general y dos especializaciones.

\subsection{Agregaciones}

Las agregaciones permiten tratar una interrelación como un elemento de nivel superior dentro del modelo Entidad-Relación. Esto resulta útil cuando una relación entre entidades debe participar, a su vez, en otra relación con nuevos elementos del dominio.

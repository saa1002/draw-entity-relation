...
% Figura: resumen de fases del desarrollo: análisis, estabilización, ampliación funcional, usabilidad, pruebas y documentación.
...
% Figura: esquema de importación JSON con reemplazo o combinación controlada.
...
% Figura: captura del editor mostrando una entidad débil, su relación identificadora y su discriminante.
...
% Figura: captura o esquema de atributos compuestos y multivaluados dentro del editor.
...
% Figura: captura del editor con una relación ternaria configurada y roles visibles.
...
% Figura: captura del editor con una jerarquía ISA sencilla formada por una generalización y varias especializaciones.
...
% Figura: captura del diálogo de validación mostrando errores agrupados del diagrama.
...
% Figura: flujo de transformación desde el diagrama validado hasta la representación relacional.
...
% Figura: ejemplo de script SQL generado a partir de un diagrama validado.
...
% Figura: captura de la barra lateral con acciones contextuales para una entidad, atributo, relación o elemento ISA.
...
% Figura: captura de la generación de estructuras básicas o de una estructura insertada en el lienzo.
...
\subsection{Ajustes en exportación, validación y vista del diagrama}
...
Otra mejora añadida fue la opción de ajustar la vista al contenido del diagrama. Esta acción centra y adapta la visualización al modelo actual sin modificar las coordenadas reales de los elementos ni alterar el modelo persistido. Resulta útil cuando el diagrama crece, cuando se importa contenido o cuando se combinan estructuras generadas con un diagrama ya existente.

Además, se realizaron pequeños ajustes de interfaz para mejorar la comodidad de uso: la barra lateral pasó a ser desplazable verticalmente cuando las acciones no caben en pantalla, el selector de idioma se simplificó mediante botones compactos ES/EN y se añadió una guía breve cuando no hay ningún elemento seleccionado. Estas mejoras no cambian la notación académica del modelo Entidad-Relación, pero ayudan a que la herramienta resulte más clara durante la edición.

% Figura: captura de las acciones globales del editor: comprobar diagrama, ajustar vista y exportar imagen.

...
Además, se revisó la forma de representar las claves foráneas en el script final. Cuando una clave foránea referencia la clave primaria completa de la tabla destino, el generador puede utilizar una forma más compacta, referenciando directamente la tabla. También se evitaron nombres explícitos innecesarios para las restricciones de clave foránea, manteniendo una sintaxis más simple y legible sin modificar la estructura relacional obtenida previamente.

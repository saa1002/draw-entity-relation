...
Entre las herramientas generales de diagramación se encuentran diagrams.net, también conocida como draw.io, y Excalidraw \cite{drawio,excalidraw}. En el ámbito más cercano al modelado de bases de datos aparecen herramientas como ERDPlus y dbdiagram.io \cite{erdplus,dbdiagram}.

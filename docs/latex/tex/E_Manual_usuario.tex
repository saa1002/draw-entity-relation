...
\begin{itemize}
\item \textbf{Generar estructura}: actualiza o muestra la estructura interna derivada del diagrama. Esta acción resulta útil como apoyo para comprobar cómo está interpretando la aplicación los elementos representados en el lienzo.

...
% Figura: cronograma general o captura de milestones/issues utilizados durante el desarrollo.
...
% Tabla sugerida: aquí se puede añadir una tabla con horas estimadas por fase si finalmente quieres cuantificar el coste.
% Ejemplo de columnas: Fase, Horas estimadas, Coste/hora, Coste total.

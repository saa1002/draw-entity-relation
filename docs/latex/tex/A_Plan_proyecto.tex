...
La Tabla~\ref{tab:licencias_proyecto} resume las principales licencias consideradas durante el desarrollo. La licencia MIT se adopta para el código desarrollado en la versión actual del proyecto, mientras que las dependencias de terceros mantienen sus respectivas licencias.
